...
public class MedicineAnalyseJPanel extends javax.swing.JPanel {
    ...
    public MedicineAnalyseJPanel(JPanel container, RescueCenterEnterprise enterprise,PharmacyOrg organization) {
        initComponents();
        ...
        for(Medicine m: enterprise.getMedicineDir().getMedicineList()) {
            ...
            for(WorkRequest wr: organization.getWorkQueue().getWorkRequestList()) {
                if(wr instanceof PharmacyWorkRequest) {
                    if(((PharmacyWorkRequest) wr).getMedicineList() != null) {
                        for(PharmacyWorkRequestUnit ru: ((PharmacyWorkRequest) wr).getMedicineList()) {
                            if(ru.getMedicine() == m) {
