...
public class MyDeliveriesJPanel extends javax.swing.JPanel {
    ...
    MyDeliveriesJPanel(JPanel container, RescueCenterEnterprise enterprise, DeliveryOrg organization, UserAccount userAccount) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for(DeliveryHistory dh: enterprise.getDeliveryHistoryDir().getDeliveryHistoryList()) {
            if(dh.getCourier() == userAccount.getEmployee()) {
                Object[] row = new Object[4];
                row[0] = dh;
                row[1] = dh.getAnimal().getType().getValue();
                row[2] = dh.getAdopter().getAddress().getCity();
                row[3] = dh.getStatus();
                model.addRow(row);
            }
        }
    ...
    private void btnSeeDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeeDetailActionPerformed
        ...
        DeliveryHistory dh = (DeliveryHistory)tblMyDeliveries.getValueAt(selectedRow, 0);
