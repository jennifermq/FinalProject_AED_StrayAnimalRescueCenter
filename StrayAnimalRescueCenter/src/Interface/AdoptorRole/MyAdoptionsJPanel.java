 ...
 * @author user
 */
public class MyAdoptionsJPanel extends javax.swing.JPanel {

    private JPanel container;
    private Adopter adoptor;
    private EcoSystem business;
    
    MyAdoptionsJPanel(JPanel container, EcoSystem business, Adopter adoptor) {
        initComponents();
    ...
    public void populateTable() {
        ...
        model.setRowCount(0);
        for(AdoptionHistory ah: adoptor.getHistoryDir().getHistoryList()) {
            Object[] row = new Object[4];
            row[0] = ah;
            row[1] = ah.getAnimal().getType().getValue();
            row[2] = ah.getAnimal().getColor();
            row[3] = ah.getStatus();
    ...
    private void btnSeeDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeeDetailActionPerformed
        ...
        AdoptionHistory ah = (AdoptionHistory)tblHistory.getValueAt(selectedRow, 0);

        CardLayout layout = (CardLayout) container.getLayout();
        container.add("SeeHistoryDetailJPanel", new SeeHistoryDetailJPanel(container, business, ah));
