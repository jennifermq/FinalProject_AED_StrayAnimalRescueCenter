...
import Business.Animal.OtherAnimal;
...
public class RegisterAnimalJPanel extends javax.swing.JPanel {
    ...
    public RegisterAnimalJPanel(JPanel container, RescueCenterEnterprise enterprise, UserAccount userAccount) {
        initComponents();
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        else if(cboxType.getSelectedItem() == Animal.AnimalType.Other
                && txtType.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Type is required!");
            return;
        }
        RescueRecord r = new RescueRecord();
        Animal a;
        if(cboxType.getSelectedItem() == Animal.AnimalType.Cat) {
            a = new Cat();
            a.setColor(txtColor.getText());
            a.setType(Animal.AnimalType.Cat);
            enterprise.getAnimalDir().addAnimal(a);
            r.setAnimal(a);
        }
        else if(cboxType.getSelectedItem() == Animal.AnimalType.Dog) {
            a = new Dog();
            a.setColor(txtColor.getText());
            a.setType(Animal.AnimalType.Dog);
            enterprise.getAnimalDir().addAnimal(a);
            r.setAnimal(a);
        }
        else if(cboxType.getSelectedItem() == Animal.AnimalType.Other) {
            a = new OtherAnimal();
            a.setColor(txtColor.getText());
            a.setType(Animal.AnimalType.Other);
            enterprise.getAnimalDir().addAnimal(a);
            r.setAnimal(a);
        }
        ...
        if(rbtnM.isSelected() == true) {
            r.getAnimal().setGender("M");
        }
        else {
            r.getAnimal().setGender("F");
        }
        
        r.setDate(d);
        r.setLocationFound(txtLocationFound.getText());
        enterprise.getRecordDir().addRescueRecord(r);
    ...
    private void cboxTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxTypeActionPerformed
        // TODO add your handling code here:
        if(cboxType.getSelectedItem() == Animal.AnimalType.Other) {
