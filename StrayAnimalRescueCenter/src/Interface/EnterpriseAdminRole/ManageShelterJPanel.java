...
import static Business.Organization.Organization.Type.Shelter;
...
public class ManageShelterJPanel extends javax.swing.JPanel {
    ...
    ManageShelterJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (ShelterCell shelter: enterprise.getShelterCellDir().getShelterCellList()){
            Object[] row = new Object[3];
            row[0] = shelter;
            row[1] = shelter.getLocation();
            row[2] = shelter.getStatus();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        ShelterCell sc = new ShelterCell();
        sc.setLocation(location);

        enterprise.getShelterCellDir().addShelterShell(sc);
        populateTable();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        ShelterCell c = (ShelterCell)tblShelter.getValueAt(selectedRow, 0);
        enterprise.getShelterCellDir().removeShelterCell(c);
        populateTable();
