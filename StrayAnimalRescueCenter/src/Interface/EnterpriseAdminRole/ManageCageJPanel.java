...
public class ManageCageJPanel extends javax.swing.JPanel {
    ...
    ManageCageJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (CageCell cage: enterprise.getCageCellDir().getCageCellList()){
            Object[] row = new Object[3];
            row[0] = cage;
            row[1] = cage.getLocation();
            row[2] = cage.getStatus();
            model.addRow(row);
        }
    }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        enterprise.getCageCellDir().addCageShell(c);
        System.out.println(c.getStatus());
        populateTable();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        enterprise.getCageCellDir().removeCageCell(c);
        populateTable();
