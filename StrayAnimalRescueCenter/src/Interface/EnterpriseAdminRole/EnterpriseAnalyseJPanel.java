...
public class EnterpriseAnalyseJPanel extends javax.swing.JPanel {
    ...
    public EnterpriseAnalyseJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    public float getDogCount() {
        float count = 0;
        for(RescueRecord rr: enterprise.getRecordDir().getRescueRecordList()) {
    ...
    public float getNoBreedRatio() {
        ...
        if(enterprise.getRecordDir().getRescueRecordList() != null) {
            return 0;
        }
        else{
            for(RescueRecord rr: enterprise.getRecordDir().getRescueRecordList()) {
