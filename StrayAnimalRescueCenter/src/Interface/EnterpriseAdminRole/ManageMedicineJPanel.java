...
public class ManageMedicineJPanel extends javax.swing.JPanel {
    ...
    public ManageMedicineJPanel(JPanel container, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (Medicine medicine : enterprise.getMedicineDir().getMedicineList()){
            ...
            row[0] = medicine.getMedicineId();
            row[1] = medicine.getName();
            row[2] = medicine.getType();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        Medicine m = null;
        if(cboxType.getSelectedItem() == Medicine.MedicineType.Anesthetics) {
            m = new Anesthetics();
            m.setType(Medicine.MedicineType.Anesthetics);
        }
        else if(cboxType.getSelectedItem() == Medicine.MedicineType.Antibiotics) {
            m = new Antibiotics();
            m.setType(Medicine.MedicineType.Antibiotics);
        }
        else if(cboxType.getSelectedItem() == Medicine.MedicineType.Vaccination) {
            m = new Vaccination();
            m.setType(Medicine.MedicineType.Vaccination);
        }
        else if(cboxType.getSelectedItem() == Medicine.MedicineType.Other) {
            m = new OtherMedicine();
            m.setType(Medicine.MedicineType.Other);
        }
        m.setName(name);
        m.setVendor(vendor);
        enterprise.getMedicineDir().addMedicine(m);
        populateTable();
