...
import Interface.AdoptorRole.AdoptionListJPanel;
import Interface.AdoptorRole.AdoptorJPanel;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(splitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 742, Short.MAX_VALUE)
        );
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(userAccount==null){
            VisitorAccount visitorAccount = system.getVisitorAccountDir().authenticateUser(userName, password);
            if(visitorAccount != null) {
                CardLayout layout=(CardLayout)container.getLayout();
                container.add("AdoptorJPanel",new AdoptorJPanel(container, system,visitorAccount.getAdoptor()));
